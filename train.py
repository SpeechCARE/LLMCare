class Alzheimer_text_classification():
    ...
    def get_classification_reports(self, pred_probs, pred_labels, true_labels):
        # Compute AUC
    ...
    def plot_training(self, loss_list, metric_list, title):
        %matplotlib inline
    ...
    def plotLoss(self, ax, loss_list, title):
    ...
    def plotMetric(self, ax, metric_list, title):
